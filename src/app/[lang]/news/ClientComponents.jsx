        ...
        <h1 style={{ marginTop: 24, maxWidth: "14ch" }} className="display-1">
          ...
          <span className="split-line">
            {t.headlineLine2.map((w, i) => (
              <span key={i} className="split-word" style={{ paddingRight: "0.18em", color: i === t.headlineLine2.length - 1 ? "var(--cs-rust)" : "inherit", fontStyle: i === t.headlineLine2.length - 1 ? "italic" : "normal" }}>{w}</span>
            ))}
          </span>
        </h1>
